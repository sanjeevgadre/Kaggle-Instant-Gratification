...
for (subset in subsets) {
  ...
  print(paste("The cross-validated number of principal components to use for subset ", subset, "=", best.comp))
...
1.  The collection of Naive Bayes models outperform the collection of the Penalised Regression models.
2.  For the Naive Bayes models, the cross validated number of principal components used vary between 10 and 56 with the majority around 40. In other words, the Naive Bayes models use even less number of principal components than the Penalised Regression models.
